...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed left-1/2 translate-x-[-50%] z-[100] flex max-h-screen w-full flex-col-reverse p-3 md:p-4 bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[600px]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-2 top-2 rounded-md p-1 text-foreground focus:outline-none focus:ring-2  group-[.destructive]:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600',
      className,
    )}
    toast-close=""
    {...props}
