...
export const signUp: SignUpGateway = async ({ email, password, confirmPassword }: SignUpUserRequest): Promise<void | SignUpError> => {
...
async function handleSignUpError(signUpTextResponse: string): Promise<SignUpError> {
