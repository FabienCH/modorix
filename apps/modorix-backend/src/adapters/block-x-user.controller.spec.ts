...
describe('BlockUserController', () => {
  ...
  describe('Block X user', () => {
    it('should block a X user', () => {
      blockXUserController.blockXUser({ id: '1', blockedAt: '2024-05-27T18:01:45Z', blockReasonIds: ['1'] });
      expect(blockXUserSpy).toHaveBeenCalledWith({ id: '1', blockedAt: '2024-05-27T18:01:45Z', blockReasonIds: ['1'] });
    });

    it('should not block a X user without reason', () => {
      expect(() => {
        blockXUserController.blockXUser({ id: '1', blockedAt: '2024-05-27T18:01:45Z', blockReasonIds: [] });
    ...
    it('should not block a X user with non existing reason', () => {
      expect(() => {
        blockXUserController.blockXUser({ id: '1', blockedAt: '2024-05-27T18:01:45Z', blockReasonIds: ['12'] });
